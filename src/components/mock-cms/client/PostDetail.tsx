      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <div className="flex-1">
              <p className="font-semibold text-slate-900 text-sm">Nguyễn Thị Hoa</p>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-xs text-slate-400 mt-0.5 mb-3">Chuyên gia Công nghệ AI · CMS</p>
              ...
              {relatedPosts.map((post) => (
                <Link key={post.title} to="/bai-viet/bai-viet-1" className="flex gap-3 group">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-xs text-slate-400 mb-1">{post.category}</p>
