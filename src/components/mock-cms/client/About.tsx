      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-200 text-lg leading-relaxed max-w-2xl mx-auto">
            Hơn 10 năm kiến tạo giải pháp công nghệ, chúng tôi tin rằng mỗi
            doanh nghiệp đều xứng đáng được trang bị công cụ tốt nhất để thành
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 mt-3">
              Đội ngũ lãnh đạo với kinh nghiệm dày dặn, đam mê công nghệ và cam
              kết với sự thành công của khách hàng
            </p>
          </div>
