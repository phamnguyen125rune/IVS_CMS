      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-20 lg:py-24 flex flex-col items-center text-center">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mb-10">
            Chúng tôi luôn tìm kiếm những tài năng đam mê công nghệ, sáng tạo và
            không ngại thử thách để cùng nhau xây dựng những sản phẩm mang lại
            giá trị thực cho cộng đồng.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Chúng tôi tin rằng nhân sự là tài sản quý giá nhất. Tại đây, bạn
              sẽ được trao quyền, hỗ trợ và ghi nhận xứng đáng.
            </p>
          </div>
