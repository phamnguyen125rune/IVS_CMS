      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">
            {posts.length} bài viết đang chờ duyệt
          </p>
        </div>
              ...
              >
                ...
                <div className="shrink-0">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Search size={isDesktop ? 18 : 16} className="text-slate-500 cursor-pointer" />
                      {isDesktop && (
                ...
                >
                  ...
                  <div className={isDesktop ? "col-span-8" : ""}>
                    ...
                    >
                      <p className={`text-slate-900 font-medium ${isDesktop ? "text-lg" : "text-base"}`}>
                        {modal.post.excerpt}
                      </p>
                      <p>
                      ...
                      <h2 className={`font-display font-bold text-slate-900 mt-8 mb-4 ${isDesktop ? "text-2xl" : "text-xl"}`}>
                      ...
                      >
                        <p className="text-blue-800 font-medium italic">
                          ...
                          được những điều mà trước đây chỉ là ước mơ." — Nguyễn Văn Hoàng, CEO CMS
                        </p>
                      </div>
                      ...
                      <p>
                        ...
                        và lo ngại về quyền riêng tư vẫn là ba rào cản lớn nhất.
                      </p>

                      <div className={`grid gap-4 my-8 ${isDesktop ? "grid-cols-3" : "grid-cols-1"}`}>
                        {[
                          ...
                          >
                            <div className="font-display font-bold text-2xl text-slate-900 mb-1">{num}</div>
                  ...
                  <div className={`${isDesktop ? "col-span-4" : "border-t border-slate-100 pt-8"} space-y-6`}>
                    <div className="border border-slate-100 rounded-2xl p-6 flex flex-col items-center text-center bg-white shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed">
                        Hơn 8 năm nghiên cứu và ứng dụng AI trong doanh nghiệp. Tác giả của 40+ bài viết chuyên sâu.
                      </p>
                    </div>
                    ...
                    <div className="border border-slate-100 rounded-2xl p-6 bg-white shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                      ...
                      <div className="space-y-4">
                        {[
                          { title: "Hướng dẫn chuyển đổi số toàn diện cho SME", cat: "Kiến thức", date: "05/07/2024", img: "1460925895917-afdab827c52f" },
                          { title: "Cloud Computing: AWS vs Google Cloud vs Azure", cat: "Công nghệ", date: "15/06/2024", img: "1451187580459-43490279c0fa" },
                          { title: "Bảo mật thông tin doanh nghiệp: 10 nguyên tắc", cat: "Bảo mật", date: "28/06/2024", img: "1555949963-aa79dcee981c" },
                        ].map((related, idx) => (
                          <div key={idx} className="flex gap-3 group cursor-pointer">
                            ...
                            <div className="flex flex-col justify-center">
                              <span className="text-[10px] text-slate-500 font-medium mb-0.5">{related.cat}</span>
                              <h5 className="text-xs font-semibold text-slate-800 leading-snug group-hover:text-blue-600 line-clamp-2">
                                {related.title}
                              </h5>
                              <span className="text-[10px] text-slate-400 mt-1">{related.date}</span>
                            </div>
                          </div>
                        ))}
                      </div>
          ...
          >
            ...
            <div className="p-6">
              <p className="text-sm text-slate-600 mb-4 leading-relaxed">
                ...
                <strong className="text-slate-900">{modal.post.author}</strong>{" "}
