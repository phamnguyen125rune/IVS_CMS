...
export default function Roles() {
  ...
  const [deletingRole, setDeletingRole] = useState<(typeof roles)[0] | null>(
    null,
  );
  ...
  const hasDraftPermission = (module: string, perm: string) =>
    draftPerms[module]?.includes(perm);
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">
            Cấu hình vai trò và quyền hạn người dùng
          </p>
        </div>
        <button
          onClick={() => {
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-slate-600 mb-6 leading-relaxed">
              ...
              ? <br />
              Hành động này{" "}
              <strong className="text-red-500">không thể hoàn tác</strong> và
              người dùng thuộc nhóm này sẽ bị mất quyền truy cập tương ứng.
            </p>
