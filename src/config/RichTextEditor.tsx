            ...
            <CKEditor
                ...
                config={{
                    ...
                    plugins: [
                        ...
                        Subscript, Superscript, Code, RemoveFormat, Highlight, Alignment,
                        BlockQuote, CodeBlock, HorizontalLine, List, ListProperties, TodoList,
                        Link, AutoLink, Image, ImageInsert, ImageCaption, ImageResize, ImageStyle,
                        ImageToolbar, MediaEmbed, Table, TableToolbar, TableProperties,
                        TableCellProperties, SpecialCharacters, FindAndReplace, SelectAll, Undo,
                        PasteFromOffice,
                    ],
                    toolbar: {
                        items: [
