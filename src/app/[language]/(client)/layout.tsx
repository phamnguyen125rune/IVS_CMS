          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 leading-relaxed mb-5">
                Công ty giải pháp công nghệ hàng đầu Việt Nam. Chúng tôi kiến
                tạo những sản phẩm số giúp doanh nghiệp phát triển bền vững.
              </p>
            ...
            {/* Navigation Links */}
            <div>
              <h4 className="text-white font-semibold font-display mb-4 text-sm">
                Điều hướng
              </h4>
        ...
        <div className="border-t border-slate-700/50">
          <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-5">
              {["Chính sách bảo mật", "Điều khoản sử dụng", "Cookie"].map(
                (item) => (
                  <a
                    key={item}
                    href="#"
