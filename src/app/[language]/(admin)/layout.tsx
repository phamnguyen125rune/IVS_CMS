...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-slate-50 font-['Plus_Jakarta_Sans'] overflow-hidden">
      ...
      {/* Sidebar - Dark Theme */}
      <aside
        className={`flex flex-col bg-slate-900 text-slate-300 transition-all duration-300 z-30 shrink-0 overflow-hidden whitespace-nowrap ${sidebarOpen ? 'w-64' : 'w-0 lg:w-20'
          }`}
      >
        {/* Logo */}
